...
// GetInt get bool value, return error if cast failed
...
// GetInt get string value, return error if cast failed
...
// GetInt get float value, return error if cast failed
